import {addEntity, deleteById, searchPage,update,updatecheck} from '@/api/spOutwarehouse'
...
let spOutwarehouse = {
    ...
    methods:{
        clearAndAdd(spApplicationid){
            this.tableData.forEach(data=>{
                if (data.spApplicationid ===spApplicationid) {
                    this.formData2 = data;
                }
            })
        },
        ...
        addOredit(){
            //   //切换路由到新增和修改
            this.$router.push({name:'AddOrEditOutwarehouse'});
        },
        ...
        async deleteById(){
            await deleteById(this.formData.spApplicationid);
            console.log(this.tableData.spApplicationid);
            this.findPage();
        },
        // getImgStr(e){
        //     console.log("imgstr===");
