<template>
    <div class="spOutwarehouse-box">
        <!--查询表单-->
        <div class="search-box">
            <el-form :inline="true" class="demo-form-inline" size="mini">
                <el-form-item label="返厂出库申请单编号">
                    <el-input placeholder="返厂出库申请单编号" v-model="searchParams.spApplicationid"></el-input>
                </el-form-item>
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column
                        ...
                        label="出库状态">
                    <template slot-scope="scope">
                        {{typeData2[scope.row.spOutstatus]}}
                    </template>
                </el-table-column>
                ...
                <el-table-column
                    ...
                    <template v-slot="obj">
                        ...
                        <el-button type="success" icon="el-icon-edit" size="mini"
                                   @click="clearAndAdd(obj.row.spApplicationid),dialogVisible2=true" >审批</el-button>

                        <el-button type="warning" icon="el-icon-edit" size="mini"
                                   @click="clearAndAdd(obj.row.spApplicationid),dialogVisible3=true">修改</el-button>
                        <el-popconfirm
                        ...
                        >
                            <el-button slot="reference" type="danger" icon="el-icon-delete" size="mini"
                                       @click="formData.spApplicationid=obj.row.spApplicationid">删除</el-button>
                        </el-popconfirm>
                    </template>
        ...
        <div class="dialog-box">
            ...
            >
                ...
                <el-form ref="form" :model="formData2" label-width="240px">
                    ...
                    <el-form-item label="返厂出库申请单编号" size="small">
                        <el-input v-model="formData2.spApplicationid" style="width: 240px;" disabled=""></el-input>
                    </el-form-item>
            ...
            >
                <el-form ref="form" :model="formData2" label-width="240px">
                    ...
                    <el-form-item label="返厂出库申请单编号" size="small">
                        <el-input v-model="formData2.spApplicationid" style="width: 240px;"  ></el-input>
                    </el-form-item>

                    <el-form-item label="订单类型">
                        <el-input v-model="formData2.spHandletype" size="small" style="width: 240px;"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="返厂地点">
                        <el-input v-model="formData2.spSites" size="small" style="width: 240px;"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="制单人">
                        <el-input type="textarea" v-model="formData2.spCreateBy" size="small" style="width: 240px;"></el-input>
                    </el-form-item>


                    <el-form-item label="制单部门">
                        <el-input v-model="formData2.spCreatedepartment" size="small" style="width: 240px;"></el-input>
                    </el-form-item>
...
<script>
    import spOutwarehouse from './index'

    export default spOutwarehouse;
</script>
