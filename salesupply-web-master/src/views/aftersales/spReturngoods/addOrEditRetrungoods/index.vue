<template>
    <div class="addOrEditReturngoods-box">
        <!--查询表单-->
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column
                        ...
                        label="操作">
                    <template v-slot="obj">
                        <el-button type="success" icon="el-icon-edit" size="mini" @click="clearAndAdd(obj.row.orderImei),dialogVisible2=true">新增退货单</el-button>
...
<script>
    import addOrEditReturngoods from './index'
