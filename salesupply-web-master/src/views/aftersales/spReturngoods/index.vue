<template>
    <div class="spReturngoods-box">
        <!--查询表单-->
        <div class="search-box">
            <el-form :inline="true" class="demo-form-inline" size="mini">
                <el-form-item label="退货申请单编号">
                    <el-input placeholder="退货申请单编号" v-model="searchParams.spOrderid"></el-input>
                </el-form-item>
        ...
        <div class="dialog-box">
            ...
            >
                ...
                <el-form ref="form" :model="formData2" label-width="240px">
                    ...
                    <el-form-item label="退货申请单编号" size="small">
            ...
            >
                <el-form ref="form" :model="formData2" label-width="240px">
                    ...
                    <el-form-item label="售后申请单编号">
                        <el-input v-model="formData2.spApplicationid" size="small" style="width: 240px;"></el-input>
                    </el-form-item>

                    <el-form-item label="商品成本">
                        <el-input v-model="formData2.spGoodscost" size="small" style="width: 240px;"></el-input>
                    </el-form-item>
...
<script>
    import spReturngoods from './index'

    export default spReturngoods;
</script>
