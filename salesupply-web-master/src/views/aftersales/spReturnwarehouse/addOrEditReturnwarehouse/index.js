import {addEntity, deleteById, searchPage,update} from '@/api/addOrEditReturnwarehouse'
...
let addOrEditReturnwarehouse = {
    ...
    methods:{
        ...
        async deleteById(){
            await deleteById(this.formData.orderId);
            console.log(this.tableData.orderId);
            this.findPage();
        },
        // getImgStr(e){
        //     console.log("imgstr===");
