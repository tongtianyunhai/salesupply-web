<template>
    <div class="spReturnwarehouse-box">
        <!--查询表单-->
        <div class="search-box">
            <el-form :inline="true" class="demo-form-inline" size="mini">
                <el-form-item label="返厂出库申请单编号">
                    <el-input placeholder="返厂出库申请单编号" v-model="searchParams.spOrderid"></el-input>
                </el-form-item>
        ...
        <div class="table-box">
            ...
            >
                ...
                <el-table-column
                        ...
                        label="出库状态">
                    <template slot-scope="scope">
                        {{typeData2[scope.row.spInstatus]}}
                    </template>
                </el-table-column>
        ...
        <div class="dialog-box">
            ...
            >
                <el-form ref="form" :model="formData2" label-width="240px">
                    ...
                    <el-form-item label="返厂出库申请单编号" size="small">
                        <el-input v-model="formData2.spOrderid" style="width: 240px;"  ></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="出库状态">
                        <el-input v-model="formData2.spInstatus" size="small" style="width: 240px;"></el-input>
                    </el-form-item>

                    <el-form-item label="入库申请编号">
                        <el-input v-model="formData2.spInorderid" size="small" style="width: 240px;"></el-input>
                    </el-form-item>
                    ...
                    <el-form-item label="备注">
                        <el-input type="textarea" v-model="formData2.spAddition" size="small" style="width: 240px;"></el-input>
                    </el-form-item>
...
<script>
    import spReturnwarehouse from './index'
