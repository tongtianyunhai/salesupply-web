<template>
    <div class="order-box">
        ...
        <div class="search-box">
            <el-form :inline="true" class="demo-form-inline" size="mini">
                ...
                <el-form-item label="订单动作：">
                    <el-select placeholder="请选择订单动作" v-model="searchParams.orderAction">
                ...
                <el-form-item>
                    ...
                    <!--<el-button type="info" @click=""  icon="el-icon-download"> 导出 </el-button>-->
        ...
        <template v-slot="obj">
            <el-button type="primary" @click="showOrderInfo(obj.row)" icon="el-icon-search">查看</el-button>
            <el-button type="info" @click="orderExcel(obj.row,open())" icon="el-icon-download">导出</el-button>
