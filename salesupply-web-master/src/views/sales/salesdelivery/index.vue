<template>
    <div class="order-box">
        ...
        <div class="search-box">
            <el-form :inline="true" class="demo-form-inline" size="mini">
                ...
                <el-form-item>
                    ...
                    <!--<el-button type="primary" @click="">生成销售出库单</el-button>-->
        ...
        <template v-slot="obj">
            <el-button @click="showOrderInfo(obj.row)" type="primary" icon="el-icon-search">查看</el-button>
            <el-button type="info" @click="salesReportExcel(obj.row,open())" icon="el-icon-download">生成销售出库单</el-button>
        </template>
